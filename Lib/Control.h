...
public:
	...
	bool CtrlAttiRate(Vector3f angle, Vector3<float> gyr, u16 RcThr, u16 RcPit, u16 RcRol, u16 RcYaw);
	
	bool CtrlAttiAng(Vector3f angle, Vector3<float> gyr, u16 RcThr, u16 RcPit, u16 RcRol, u16 RcYaw);
	//串级PID
	bool SeriesPIDControl(Vector3f angle, Vector3<float> gyr, u16 RcThr, u16 RcPit, u16 RcRol, u16 RcYaw);
	//test
	bool ServoControl(Vector3f angle, Vector3<float> gyr, u16 RcThr, u16 RcPit, u16 RcRol, u16 RcYaw);
	//Control
	bool ControlMotor(u16 RcThr);
	//
	bool TestControl(Vector3f angle, Vector3<float> gyr, u16 RcThr, u16 RcPit, u16 RcRol, u16 RcYaw);
