...
public:
	/*
	*remap 0: No PinRemap
	*remap 1: ParialPinRemap (for TIM2 GPIO_PartialRemap1_TIM2)
	*remap 2: FullPinRemap
	*remap 3: ParialPinRemap 2 (for TIM2 GPIO_PartialRemap2_TIM2)
	*/
	PWM(TIM_TypeDef *timx,bool enCh1,bool enCh2,bool enCh3, bool enCh4, u16 frq, u8 remap = 0);
	void Initialize(TIM_TypeDef *timx,bool enCh1,bool enCh2,bool enCh3, bool enCh4, u16 frq, u8 remap = 0);
